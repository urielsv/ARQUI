...
_numToString:
                ...
                pop             eax                             ; Number
                pop             ebx                             ; Counter (size of string)
                push            ebp                             ; Save base pointer
                push            ebx                             ; Save return value (size of string)
                ...
                flip:
                pop             ebx                             ; Restore ebx (size of string)
                mov             ecx, ebx                        ; init ecx w/ size of string
                xor             ax, ax                          ; clear ax
...
section         .bss
buffer          resd            20              ; space for 1 dword (4 bytes)
